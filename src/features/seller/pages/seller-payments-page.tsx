...
import { CalendarDays, ExternalLink, RefreshCw, Wallet } from 'lucide-react'
import { useSellerPaymentsQuery } from '@/features/payments/hooks/use-payments'
...
export function SellerPaymentsPage() {
  ...
  const paymentsQuery = useSellerPaymentsQuery(Boolean(accessToken))
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <p className="text-sm text-destructive">
            {getApiErrorMessage(paymentsQuery.error, 'Không tải được lịch sử doanh thu.')}
          </p>
    ...
    return (
      <Card>
        <EmptyState
          ...
          description="Các khoản thanh toán từ đơn hàng của cửa hàng sẽ hiển thị tại đây."
          action={
